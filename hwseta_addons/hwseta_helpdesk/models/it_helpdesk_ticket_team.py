...
class ITHelpdeskTeam(models.Model):

    _name = "it.helpdesk.ticket.team"
    ...
    user_ids = fields.Many2many(
        ...
        string="Members",
        relation="it_helpdesk_ticket_team_res_users_rel",
        column1="helpdesk_ticket_it_team_id",
    ...
    ticket_ids = fields.One2many(
        comodel_name="seta.it.helpdesk",
        inverse_name="it_team_id",
        string="Tickets",
    )
    ...
    def _compute_todo_tickets(self):
        ticket_model = self.env["seta.it.helpdesk"]
        fetch_data = ticket_model.read_group(
            [("it_team_id", "in", self.ids), ("closed", "=", False)],
            ["it_team_id", "user_id", "unattended", "priority"],
            ["it_team_id", "user_id", "unattended", "priority"],
            lazy=False,
        )
        result = [
